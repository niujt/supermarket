...
<body>
<audio controls="controls"  hidden="hidden" autoplay="autoplay" loop=-1>

  <source src="${pageContext.request.contextPath }/statics/music/bgm.mp3" type="audio/mpeg" />
	...
	<div class="login-box">
		...
		<form method="post"
			...
			<div class="role">
				<label for="权限" class="p">权限：</label> <select id="userRole"
					name="userRole">
